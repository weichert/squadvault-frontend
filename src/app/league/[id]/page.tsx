...
import { RecentArtifact } from '@/components/ui/recent-artifact';
import { CharterRow } from '@/components/ui/charter-row';
  ...
  return (
    <main className="plaque-overlap" style={{ background: 'var(--vault-bg)', minHeight: '100vh', position: 'relative', zIndex: 1 }}>
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <RecentArtifact leagueId={id} />
        <TrophyPreview leagueId={id} />
        <CharterRow leagueId={id} />
      </div>
    </main>
  );
}
