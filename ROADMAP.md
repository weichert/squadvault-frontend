...
| CO-SPEC | Coach Office room spec v1 formally ratified (CO-R1..R4) - memo `docs/coach_office/RATIFICATION_MEMO_2026_07_04.md`; existing `docs/coach_office/final_spec_package_v1/` canonical (no re-copy/rename) | Done | (hash post-merge) |
